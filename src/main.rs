...
const DEFAULT_CONFIG_TOML: &str = r#"poll_interval_secs = 60
idle_after_secs = 300
...
chat = [
  ...
  "gajim", "dino", "fractal", "io.gitlab.diasporg.diaspora",
  "ferdium", "rambox", "skypeforlinux",
]
design = [
  ...
  "darktable", "rawtherapee", "scribus", "boxy-svg",
]
media = [
  "kdenlive", "org.kde.kdenlive", "shotcut", "org.shotcut.Shotcut",
  "openshot", "davinci-resolve", "blackmagic-design-davinci-resolve",
  "audacity", "org.audacityteam.Audacity",
  "ardour", "org.ardour.Ardour", "lmms", "io.lmms.LMMS",
  "obs", "com.obsproject.Studio", "handbrake", "fr.handbrake.ghb",
]
productivity = [
  "obsidian", "md.obsidian.Obsidian", "logseq", "com.logseq.Logseq",
  "joplin", "net.cozic.joplin_desktop",
  "notion-app", "anytype", "zettlr", "standardnotes",
  "appflowy", "io.appflowy.AppFlowy", "trilium",
  "marktext", "com.github.marktext.marktext", "ghostwriter",
]
video = [
  "mpv", "io.mpv.Mpv", "vlc", "org.videolan.VLC",
  "celluloid", "smplayer", "haruna", "stremio", "freetube",
]
games = [
...
music = [
  ...
  "rhythmbox", "elisa", "strawberry",
  "amberol", "io.bassi.Amberol",
  "audacious", "lollypop", "tauon", "cmus",
]
...
coding = [
  ...
  "railway.app", "railway.com", "fly.io", "render.com", "deno.com",
  "supabase.com", "planetscale.com", "neon.tech", "turso.tech", "xata.io",
  "console.aws.amazon.com", "cloud.google.com", "portal.azure.com",
  "console.digitalocean.com", "linode.com", "vultr.com",
  "npmjs.com", "pypi.org", "crates.io", "rubygems.org", "packagist.org", "jsr.io",
  "hex.pm", "mvnrepository.com", "nuget.org",
  "developer.mozilla.org", "web.dev", "caniuse.com", "regex101.com", "godbolt.org",
  "docs.python.org", "docs.rs", "doc.rust-lang.org", "nodejs.org", "deno.land",
  "react.dev", "nextjs.org", "vuejs.org", "svelte.dev", "remix.run", "qwik.dev",
  "tailwindcss.com", "typescriptlang.org", "biomejs.dev",
  "learn.microsoft.com", "developers.google.com", "developer.apple.com",
  "kubernetes.io", "helm.sh", "docker.com", "podman.io",
  "nixos.org", "wiki.nixos.org", "search.nixos.org", "huggingface.co",
  "dev.to", "hashnode.com", "lobste.rs", "freecodecamp.org",
]
ai = [
  ...
  "grok.com", "x.ai", "copilot.microsoft.com", "labs.google",
  "console.anthropic.com", "aistudio.google.com",
  "cursor.sh", "cursor.com", "lovable.dev", "v0.dev", "bolt.new",
  "replit.com", "codeium.com", "windsurf.com", "sourcegraph.com",
  "magic.dev", "factory.ai", "devin.ai", "cognition.ai",
  "ollama.com", "lmstudio.ai", "groq.com", "fireworks.ai", "together.ai",
  "replicate.com", "civitai.com", "leonardo.ai", "runwayml.com",
  "elevenlabs.io", "suno.com", "udio.com", "ideogram.ai",
  "openrouter.ai", "anyscale.com", "modal.com", "wandb.ai",
  "character.ai", "characters.ai", "huggingface.co",
  "labs.openai.com", "playground.openai.com",
]
design = [
  "figma.com", "sketch.com", "framer.com", "behance.net", "dribbble.com",
  "midjourney.com", "unsplash.com", "pexels.com", "pinterest.com",
  "excalidraw.com", "tldraw.com", "app.diagrams.net", "miro.com",
  "canva.com", "penpot.app", "rive.app", "spline.design",
  "lottiefiles.com", "iconify.design", "fontawesome.com",
  "fonts.google.com", "coolors.co", "color-hex.com",
  "are.na", "siteinspire.com", "awwwards.com",
]
productivity = [
  ...
  "things.app", "ticktick.com", "any.do",
  "calendar.google.com", "cal.com", "calendly.com",
  "docs.google.com", "sheets.google.com", "slides.google.com",
  "office.com", "office.live.com",
  "obsidian.md", "logseq.com", "roamresearch.com",
  "remnote.com", "capacities.io", "tana.inc",
]
chat = [
  ...
  "matrix.org", "irc.libera.chat", "mattermost.com",
  "rocket.chat", "zulip.com",
]
email = [
  "mail.google.com", "outlook.live.com", "outlook.office.com",
  "mail.proton.me", "fastmail.com", "mail.yahoo.com",
  "mail.aol.com", "mail.zoho.com", "tutanota.com", "tuta.com",
  "hey.com", "missiveapp.com", "superhuman.com",
  "mailchimp.com", "convertkit.com", "buttondown.email",
]
storage = [
  "drive.google.com", "dropbox.com", "icloud.com",
  "onedrive.live.com", "mega.nz", "box.com", "pcloud.com",
  "sync.com", "filen.io", "tresorit.com",
]
meeting = [
  "meet.google.com", "zoom.us", "app.zoom.us", "whereby.com", "around.co",
  "tldv.io", "fathom.video", "fellow.app",
  "gather.town", "tactiq.io", "otter.ai",
]
video = [
  "youtube.com", "youtu.be", "m.youtube.com",
  "vimeo.com", "netflix.com", "twitch.tv",
  "primevideo.com", "hulu.com", "disneyplus.com",
  "hbomax.com", "max.com", "peacocktv.com", "paramount.plus", "appletv.com",
  "kick.com", "dailymotion.com", "rumble.com", "nebula.tv", "patreon.com",
  "crunchyroll.com", "funimation.com", "iqiyi.com", "viki.com",
  "plex.tv", "jellyfin.org", "tubi.tv", "pluto.tv",
  "mubi.com", "criterionchannel.com",
]
music = [
...
scroll = [
  ...
  "tumblr.com", "9gag.com", "imgur.com",
  "linkedin.com", "mastodon.social", "mastodon.world", "fosstodon.org",
  "news.ycombinator.com", "lemmy.world", "kbin.social", "lemmy.ml",
  "snapchat.com", "vk.com", "weibo.com",
  "pinterest.com",
]
news = [
  "theverge.com", "techcrunch.com", "arstechnica.com", "wired.com",
  "engadget.com", "9to5google.com", "9to5mac.com", "macrumors.com",
  "nytimes.com", "washingtonpost.com", "wsj.com", "bloomberg.com",
  "ft.com", "economist.com", "reuters.com", "apnews.com",
  "bbc.com", "bbc.co.uk", "theguardian.com", "npr.org", "axios.com",
  "substack.com", "ground.news",
  "spiegel.de", "zeit.de", "faz.net", "sueddeutsche.de", "welt.de",
  "lemonde.fr", "lefigaro.fr",
  "elpais.com", "elmundo.es",
  "asahi.com", "japantimes.co.jp",
  "thelocal.com", "dw.com",
  "politico.com", "thehill.com", "vox.com", "slate.com",
  "newyorker.com", "theatlantic.com", "vanityfair.com",
  "huffpost.com", "nbcnews.com", "cbsnews.com", "abcnews.go.com",
  "cnn.com", "foxnews.com",
  "drudgereport.com", "google.com/news", "news.google.com",
  "rss.app", "feedly.com", "inoreader.com",
]
shopping = [
  "amazon.com", "amazon.de", "amazon.co.uk", "amazon.ca", "amazon.fr", "amazon.it", "amazon.es", "amazon.co.jp",
  "ebay.com", "ebay.de", "ebay.co.uk",
  "etsy.com", "aliexpress.com", "temu.com", "shein.com",
  "target.com", "walmart.com", "bestbuy.com", "costco.com",
  "ikea.com", "wayfair.com", "newegg.com",
  "zalando.com", "asos.com", "uniqlo.com", "hm.com", "zara.com",
  "nike.com", "adidas.com", "patagonia.com", "rei.com",
  "apple.com", "store.steampowered.com",
...
finance = [
  ...
  "etoro.com", "trade.com", "interactivebrokers.com",
  "coinbase.com", "kraken.com", "binance.com", "bybit.com", "kucoin.com",
  "metamask.io", "phantom.app", "rabby.io",
  "mint.com", "ynab.com", "monarchmoney.com", "rocketmoney.com",
  "splitwise.com", "expensify.com",
  "tradingview.com", "yahoo.com/finance", "finance.yahoo.com",
]
learning = [
  "coursera.org", "udemy.com", "edx.org", "khanacademy.org",
  "brilliant.org", "duolingo.com", "babbel.com", "memrise.com", "rosetta.stone.com",
  "frontendmasters.com", "egghead.io", "pluralsight.com", "linkedin.com/learning",
  "leetcode.com", "hackerrank.com", "codewars.com", "exercism.org",
  "adventofcode.com", "advent-of-code.com", "projecteuler.net",
  "youtube.com/learn", "youtube.com/edu",
  "skillshare.com", "masterclass.com", "datacamp.com",
  "freecodecamp.org", "theodinproject.com", "fullstackopen.com",
  "roadmap.sh", "boot.dev", "codecademy.com",
]
search = [
  "google.com", "www.google.com",
  "duckduckgo.com", "kagi.com", "brave.com/search",
  "ecosia.org", "bing.com", "qwant.com", "startpage.com", "you.com",
  "wolframalpha.com",
]
reference = [
  "wikipedia.org", "en.wikipedia.org", "de.wikipedia.org",
  "wiktionary.org", "wikidata.org", "commons.wikimedia.org",
  "archive.org", "web.archive.org", "scholar.google.com",
  "britannica.com", "merriam-webster.com", "dictionary.com", "thesaurus.com",
  "stackoverflow.com",
]
devops = [
  "datadoghq.com", "datadog.com", "sentry.io", "rollbar.com", "bugsnag.com",
  "honeycomb.io", "newrelic.com", "grafana.com", "grafana.net",
  "prometheus.io", "elastic.co", "kibana.co", "splunk.com", "logz.io",
  "pagerduty.com", "opsgenie.com", "incident.io", "rootly.com",
  "statuspage.io", "betteruptime.com", "uptimerobot.com",
  "terraform.io", "hashicorp.com", "pulumi.com", "ansible.com",
  "docker.io", "hub.docker.com", "tailscale.com", "zerotier.com",
  "argoproj.io", "argocd.com", "circleci.com", "buildkite.com", "drone.io",
]
travel = [
  "booking.com", "airbnb.com", "kayak.com", "expedia.com",
  "hotels.com", "skyscanner.com", "google.com/flights", "google.com/travel",
  "tripadvisor.com", "hostelworld.com", "agoda.com",
  "uber.com", "lyft.com", "blablacar.com",
  "rome2rio.com", "trainline.com", "omio.com", "trip.com",
  "lonelyplanet.com", "nomadlist.com",
]
food = [
  "doordash.com", "ubereats.com", "grubhub.com", "deliveroo.com", "justeat.com",
  "yelp.com", "opentable.com", "resy.com",
  "allrecipes.com", "foodnetwork.com", "seriouseats.com", "bonappetit.com",
  "cooking.nytimes.com", "smittenkitchen.com", "epicurious.com",
  "thekitchn.com", "food52.com",
]
sports = [
  "espn.com", "theathletic.com", "skysports.com",
  "nba.com", "nfl.com", "mlb.com", "nhl.com",
  "premierleague.com", "bundesliga.com", "uefa.com", "fifa.com",
  "f1.com", "formula1.com",
  "ufc.com", "atp.com", "atptour.com", "wta.com",
  "fotmob.com", "flashscore.com", "transfermarkt.com",
]
health = [
  "webmd.com", "healthline.com", "mayoclinic.org",
  "myfitnesspal.com", "cronometer.com", "macrofactorapp.com",
  "strava.com", "garmin.com/connect", "ouraring.com", "whoop.com",
  "headspace.com", "calm.com", "insighttimer.com",
  "10minutemail.com", "drugs.com",
]
read_later = [
  "getpocket.com", "instapaper.com", "raindrop.io",
  "pinboard.in", "omnivore.app", "readwise.io", "matter.app",
  "pocket.com",
]
